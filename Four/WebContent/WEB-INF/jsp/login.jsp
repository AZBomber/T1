			...
			<div class="wrap">
				<div class="main">
					<div class="title">
						...
						<c:if test="${registsucceed==null&&loginerror==null}">USER LOGIN</c:if>
                          <c:if test="${registsucceed!=null}">${registsucceed}</c:if>
					</div>
					<div>
						<s:actionerror />
					</div>
					<form id="loginForm"
						action="${ pageContext.request.contextPath }/logining"
